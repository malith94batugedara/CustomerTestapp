...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <h1 class="text-center mt-2">Customer List</h1>
    <div class="text-center"><a href="{{ route('welcome') }}" class="btn btn-success">Add New Customer</a></div>
    <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" value="{{ $customer->id }}" class="btn btn-danger deleteCustomerBtn">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
    ...
    <script>
         ...
         $(document).on('click','.deleteCustomerBtn',function() {
            ...
            $('#customer_delete_id').val(customer_id);
